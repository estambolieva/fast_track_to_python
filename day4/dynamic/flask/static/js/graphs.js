...
function makeGraphs(error, projectsJson, statesJson) {
	...
	//Create a Crossfilter instance - put all project data there
	...
	//Calculate metrics
	//define 6 data groups - 1 per each field, and 1 for all fields
    ...
    // chart number of donations, a numberDisplay chart
	numberProjectsND
		.formatNumber(d3.format("d"))
		.valueAccessor(function(d){return d; })
		.group(all);

    // total number of donations, a numberDisplay chart
	totalDonationsND
		.formatNumber(d3.format("d"))
		.valueAccessor(function(d){return d; })
    ...
    // number of donations by given month, a bar chart
	timeChart
		.width(600)
		.height(160)
    ...
    // resource type chart, a row chart
	resourceTypeChart
        .width(300)
        .height(250)
